...
ActiveRecord::Schema.define(version: 20150812091155) do
  ...
  create_table "subsite_contacts", force: :cascade do |t|
    t.string   "name"
    t.string   "email"
    t.string   "subject"
    t.text     "message"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "is_twitter_email_verified",  default: false, null: false
    t.boolean  "is_facebook_email_verified", default: false, null: false
  end
